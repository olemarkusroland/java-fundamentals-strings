...
public class Exercise {
    ...
    public String domain = url.substring(url.indexOf("://")+3, url.lastIndexOf("/"));
    ...
    public String notPath = url.substring(0, url.lastIndexOf("/")+1);
    public String faqUrl = notPath + "faq";
}
